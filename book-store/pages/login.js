...
export default function Login() {
  ...
  const containerStyle = {
    ...
    minHeight: '100vh',
    background: 'linear-gradient(to right,rgb(245, 245, 245),#3E2723', // Blue to Purple gradient
  };

  const formStyle = {
    background: 'linear-gradient(to right,rgb(11, 13, 19), #3E2723)', // Dark Blue to Purple gradient
    padding: '2.5rem',
    borderRadius: '1.5rem',
    width: '100%',
    maxWidth: '600px',
  ...
  const buttonStyle = {
    width: '100%',
    padding: '1.25rem',
    background: 'linear-gradient(to right,#3E2723, #3E2723)', // Blue to Purple gradient
    color: 'white',
    fontSize: '1.25rem',
    fontWeight: 600,
    border: 'none',
